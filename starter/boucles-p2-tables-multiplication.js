...
const tableMultiplication =parseInt(prompt("entrer le nombre d'une table de multiplication"));
const nombreValeur = parseInt(prompt("entrer de combien de valeur que vous voulez voir ")) ;
let result;
